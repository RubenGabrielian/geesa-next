...
import aboutImage from "../../public/11.jpg";

export default function HomeAbout({data}) {
    return (
        <div className="container">
            <div className="home-about">
                <h2>{data.acf.big_title}</h2>
                <p>
                  {data.acf.small_description}
                </p>
                <div className="row home-about-advs">
                    <div className="col-md-6">
                        <h3>{data.acf.our_advantages_title}</h3>
                        <small>
                            {data.acf.our_advantages_text}
                        </small>
                        <img
                            alt="About Geesa"
                            src={data.acf.advantages_image}
                    ...
                    <div className="col-md-6">
                        <div className="adv-item">
                            ...
                            <span>{data.acf.advantages_1}</span>
                        </div>
                        <div className="adv-item">
                            ...
                            <span>{data.acf.advantages_2}</span>
                        </div>
                        <div className="adv-item">
                            ...
                            <span>{data.acf.advantages_3}</span>
                        </div>
                    </div>
                </div>
            </div>
